...
namespace jtf_Project.Admin.Controllers
{
    ...
    public class AccountController : BaseController
    {
        ...
        public ActionResult Login(string returnUrl)
       {
        ...
        {
            ViewBag.Response = "Please enter your Email.";
            return View(new ForgotPasswordViewModel() { IsReadOnlyEmail = false, Verified = false });
        }
        ...
        private bool IsUserInAdminRole(string userid)
        {
            string[] adminUserRoles = ConstantRoles.AdminRoles.Split(',');
                //ConfigurationManager.AppSettings["AdminAuthUsers"].ToString().Split(',');
            bool isInRole = false;
